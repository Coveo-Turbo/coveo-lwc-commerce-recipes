...
import CommerceFacet from 'c/commerceFacet';
...
function createTestComponent(options = defaultOptions) {
  ...
  const element = createElement('c-commerce-facet', {
    is: CommerceFacet,
  });
...
function mockSuccessfulHeadlessInitialization() {
  ...
  mockHeadlessLoader.initializeWithHeadless = (element, _, initialize) => {
    if (element instanceof CommerceFacet && !isInitialized) {
      isInitialized = true;
