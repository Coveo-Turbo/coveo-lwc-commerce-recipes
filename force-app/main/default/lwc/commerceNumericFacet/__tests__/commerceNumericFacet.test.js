...
import CommerceNumericFacet from 'c/commerceNumericFacet';
...
const selectors = {
  ...
  componentError: 'c-commerce-component-error',
};
...
const parentFacetIdError = `The ${exampleField} c-commerce-numeric-facet requires dependsOn.parentFacetId to be a valid string.`;
const expectedValueError = `The ${exampleField} c-commerce-numeric-facet requires dependsOn.expectedValue to be a valid string.`;

function createTestComponent(options = defaultOptions) {
  prepareHeadlessState();

  const element = createElement('c-commerce-numeric-facet', {
    is: CommerceNumericFacet,
  });
...
function mockSuccessfulHeadlessInitialization() {
  ...
  mockHeadlessLoader.initializeWithHeadless = (element, _, initialize) => {
    if (element instanceof CommerceNumericFacet && !isInitialized) {
      isInitialized = true;
