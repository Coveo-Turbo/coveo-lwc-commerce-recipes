...
import CommerceProductMultiValueText from '../commerceProductMultiValueText';
...
function createTestComponent(options = defaultOptions) {
  const element = createElement('c-commerce-product-multi-value-text', {
    is: CommerceProductMultiValueText,
  });
...
describe('c-commerce-product-multi-value-text', () => {
  function cleanup() {
  ...
  describe('when no result is given', () => {
    it('should show an error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith(
        'The c-commerce-product-multi-value-text requires a result and a multi-value field to be specified.'
      );
      expect(console.error).toHaveBeenCalledWith(
