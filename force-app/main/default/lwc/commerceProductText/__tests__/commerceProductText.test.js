...
import CommerceProductText from '../commerceProductText';
...
function createTestComponent(options = defaultOptions) {
  const element = createElement('c-commercer-product-text', {
    is: CommerceProductText,
  });
...
describe('c-commerce-product-text', () => {
  function cleanup() {
  ...
  describe('when no result is given', () => {
    it('should show an error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith(
        'The c-commerce-product-text requires a result and a field to be specified.'
      );
    });
  });
