...
import dayPattern from '@salesforce/label/c.commerce_DatePatternDay';
import monthPattern from '@salesforce/label/c.commerce_DatePatternMonth';
import yearPattern from '@salesforce/label/c.commerce_DatePatternYear';
import nextDay from '@salesforce/label/c.commerce_NextDay';
import nextDay_plural from '@salesforce/label/c.commerce_NextDay_plural';
import nextHour from '@salesforce/label/c.commerce_NextHour';
import nextHour_plural from '@salesforce/label/c.commerce_NextHour_plural';
import nextMonth from '@salesforce/label/c.commerce_NextMonth';
import nextMonth_plural from '@salesforce/label/c.commerce_NextMonth_plural';
import nextQuarter from '@salesforce/label/c.commerce_NextQuarter';
import nextQuarter_plural from '@salesforce/label/c.commerce_NextQuarter_plural';
import nextWeek from '@salesforce/label/c.commerce_NextWeek';
import nextWeek_plural from '@salesforce/label/c.commerce_NextWeek_plural';
import nextYear from '@salesforce/label/c.commerce_NextYear';
import nextYear_plural from '@salesforce/label/c.commerce_NextYear_plural';
import pastDay from '@salesforce/label/c.commerce_PastDay';
import pastDay_plural from '@salesforce/label/c.commerce_PastDay_plural';

/** @typedef {import("coveo").RelativeDate} RelativeDate */
import pastHour from '@salesforce/label/c.commerce_PastHour';
import pastHour_plural from '@salesforce/label/c.commerce_PastHour_plural';
import pastMonth from '@salesforce/label/c.commerce_PastMonth';
import pastMonth_plural from '@salesforce/label/c.commerce_PastMonth_plural';
import pastQuarter from '@salesforce/label/c.commerce_PastQuarter';
import pastQuarter_plural from '@salesforce/label/c.commerce_PastQuarter_plural';
import pastWeek from '@salesforce/label/c.commerce_PastWeek';
import pastWeek_plural from '@salesforce/label/c.commerce_PastWeek_plural';
...
export function AriaLiveRegion(regionName, elem, assertive = false) {
  function dispatchMessage(message) {
    const ariaLiveMessageEvent = new CustomEvent('commerce__arialivemessage', {
      bubbles: true,
      composed: true,
      detail: {
        regionName,
  ...
  function registerRegion() {
    const registerRegionEvent = new CustomEvent('commerce__registerregion', {
      bubbles: true,
      composed: true,
      detail: {
        regionName,
